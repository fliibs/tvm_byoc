 ...
 */
#ifndef TVM_RELAY_BACKEND_CONTRIB_CODEGEN_C_CODEGEN_BYOC_H_
#define TVM_RELAY_BACKEND_CONTRIB_CODEGEN_C_CODEGEN_BYOC_H_
...
struct Conv2dFuncResult
{
    std::string macro_stream_o;
    std::string decl_stream_o;
};
